  ...
  return (
    <main className="flex flex-col min-h-screen bg-gray-50 pb-24">
      ...
      <div className="max-w-4xl mx-auto w-full px-4 py-8">
        ...
        {/* User Address and Mint Count */}
        <div className="bg-white rounded-lg shadow-sm p-6 mb-8">
          <h2 className="text-xl font-bold mb-4">Your Address</h2>
          <div className="flex flex-col md:flex-row items-center justify-between">
            <div className="font-mono text-sm overflow-hidden overflow-ellipsis mb-2 md:mb-0">
              {userAddress}
            </div>
          ...
          {categories.map((category) => (
            <button
              ...
              className={`px-6 py-2 rounded-full text-sm font-medium transition-colors ${
                activeCategory === category ? "bg-blue-600 text-gray-200" : "bg-gray-100 text-gray-700 hover:bg-gray-200"
              }`}
            >
              {category}
            </button>
      ...
      <div className="fixed bottom-0 left-0 right-0 bg-white border-t p-2 shadow-lg">
        <div className="flex justify-around max-w-xs mx-auto">
          ...
          <button className="flex-1 flex flex-col items-center py-3 relative" disabled>
            ...
            <div className="h-10 w-10 bg-gradient-to-r from-blue-500 to-cyan-500 rounded-full flex items-center justify-center mb-1 text-gray-200 shadow-md">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="20"
                height="20"
